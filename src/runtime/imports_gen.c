...
/* 307 imports across 11 DLLs. 248 purge counts derived, 59 hand-written,
 * 0 refused (see gen_imports.py -- a refusal aborts, it does not guess). */
...
/* MSVCP60.dll!??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____Y__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV01_ABV01__Z(void) { IMPORT_STUB("??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z"); RET(0); STDRET(1); }
...
/* MSVCP60.dll!??1?$basic_fstream@DU?$char_traits@D@std@@@std@@UAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1__basic_fstream_DU__char_traits_D_std___std__UAE_XZ(void) { IMPORT_STUB("??1?$basic_fstream@DU?$char_traits@D@std@@@std@@UAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____Y__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV01_PBD_Z(void) { IMPORT_STUB("??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z"); RET(0); STDRET(1); }
/* MSVCP60.dll!??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____0__basic_ios_DU__char_traits_D_std___std__IAE_XZ(void) { IMPORT_STUB("??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?clear@ios_base@std@@QAEXH_N@Z  (thiscall, 2 slots, hand-written) */
static void imp_MSVCP60___clear_ios_base_std__QAEXH_N_Z(void) { IMPORT_STUB("?clear@ios_base@std@@QAEXH_N@Z"); RET(0); STDRET(2); }
...
/* MSVCP60.dll!?find_first_not_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___find_first_not_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z(void) { IMPORT_STUB("?find_first_not_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z"); RET(0); STDRET(3); }
/* MSVCP60.dll!?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60___max_size___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIXZ(void) { IMPORT_STUB("?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?find@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___find___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z(void) { IMPORT_STUB("?find@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z"); RET(0); STDRET(3); }
...
/* MSVCP60.dll!??_F?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60_____F__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEXXZ(void) { IMPORT_STUB("??_F?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ"); RET(0); STDRET(0); }
...
/* MSVCP60.dll!?replace@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IIABV12@II@Z  (thiscall, 5 slots, hand-written) */
static void imp_MSVCP60___replace___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV12_IIABV12_II_Z(void) { IMPORT_STUB("?replace@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IIABV12@II@Z"); RET(0); STDRET(5); }
/* MSVCP60.dll!?find_last_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___find_last_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z(void) { IMPORT_STUB("?find_last_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z"); RET(0); STDRET(3); }
/* MSVCP60.dll!?find_last_not_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___find_last_not_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z(void) { IMPORT_STUB("?find_last_not_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z"); RET(0); STDRET(3); }
/* MSVCP60.dll!?copy@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPADII@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___copy___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPADII_Z(void) { IMPORT_STUB("?copy@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPADII@Z"); RET(0); STDRET(3); }
/* MSVCP60.dll!?_Copy@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXI@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____Copy___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEXI_Z(void) { IMPORT_STUB("?_Copy@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXI@Z"); RET(0); STDRET(1); }
...
/* MSVCP60.dll!?_Split@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXXZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____Split___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEXXZ(void) { IMPORT_STUB("?_Split@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXXZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?setstate@?$basic_ios@DU?$char_traits@D@std@@@std@@QAEXH_N@Z  (thiscall, 2 slots, hand-written) */
...
static void imp_MSVCP60____1locale_std__QAE_XZ(void) { IMPORT_STUB("??1locale@std@@QAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??1?$basic_streambuf@DU?$char_traits@D@std@@@std@@UAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1__basic_streambuf_DU__char_traits_D_std___std__UAE_XZ(void) { IMPORT_STUB("??1?$basic_streambuf@DU?$char_traits@D@std@@@std@@UAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@ID@Z  (thiscall, 2 slots, hand-written) */
static void imp_MSVCP60___append___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV12_ID_Z(void) { IMPORT_STUB("?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@ID@Z"); RET(0); STDRET(2); }
/* MSVCP60.dll!?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z  (thiscall, 2 slots, hand-written) */
...
/* MSVCP60.dll!??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z  (thiscall, 1 slots, hand-written) */
...
static void imp_MSVCP60___clear___basic_ios_DU__char_traits_D_std___std__QAEXH_N_Z(void) { IMPORT_STUB("?clear@?$basic_ios@DU?$char_traits@D@std@@@std@@QAEXH_N@Z"); RET(0); STDRET(2); }
/* MSVCP60.dll!??1?$basic_filebuf@DU?$char_traits@D@std@@@std@@UAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1__basic_filebuf_DU__char_traits_D_std___std__UAE_XZ(void) { IMPORT_STUB("??1?$basic_filebuf@DU?$char_traits@D@std@@@std@@UAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??_D?$basic_fstream@DU?$char_traits@D@std@@@std@@QAEXXZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60_____D__basic_fstream_DU__char_traits_D_std___std__QAEXXZ(void) { IMPORT_STUB("??_D?$basic_fstream@DU?$char_traits@D@std@@@std@@QAEXXZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??1ios_base@std@@UAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1ios_base_std__UAE_XZ(void) { IMPORT_STUB("??1ios_base@std@@UAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1__basic_ios_DU__char_traits_D_std___std__UAE_XZ(void) { IMPORT_STUB("??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??1Init@ios_base@std@@QAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1Init_ios_base_std__QAE_XZ(void) { IMPORT_STUB("??1Init@ios_base@std@@QAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??1_Winit@std@@QAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____1_Winit_std__QAE_XZ(void) { IMPORT_STUB("??1_Winit@std@@QAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!??0_Winit@std@@QAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____0_Winit_std__QAE_XZ(void) { IMPORT_STUB("??0_Winit@std@@QAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?find_first_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___find_first_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z(void) { IMPORT_STUB("?find_first_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z"); RET(0); STDRET(3); }
/* MSVCP60.dll!??0Init@ios_base@std@@QAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____0Init_ios_base_std__QAE_XZ(void) { IMPORT_STUB("??0Init@ios_base@std@@QAE@XZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?substr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV12@II@Z  (thiscall, 3 slots, hand-written) */
static void imp_MSVCP60___substr___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBE_AV12_II_Z(void) { IMPORT_STUB("?substr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV12@II@Z"); RET(0); STDRET(3); }
...
/* MSVCP60.dll!??0_Lockit@std@@QAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____0_Lockit_std__QAE_XZ(void) { IMPORT_STUB("??0_Lockit@std@@QAE@XZ"); RET(0); STDRET(0); }
...
static void imp_MSVCP60____Grow___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAE_NI_N_Z(void) { IMPORT_STUB("?_Grow@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAE_NI_N@Z"); RET(0); STDRET(2); }
/* MSVCP60.dll!?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXI@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____Eos___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEXI_Z(void) { IMPORT_STUB("?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXI@Z"); RET(0); STDRET(1); }
/* MSVCP60.dll!?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@ABV12@II@Z  (thiscall, 3 slots, hand-written) */
...
static void imp_MSVCP60___assign___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV12_PBDI_Z(void) { IMPORT_STUB("?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@PBDI@Z"); RET(0); STDRET(2); }
/* MSVCP60.dll!??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV?$allocator@D@1@@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____0__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAE_ABV__allocator_D_1__Z(void) { IMPORT_STUB("??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV?$allocator@D@1@@Z"); RET(0); STDRET(1); }
...
/* MSVCP60.dll!??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDABV?$allocator@D@1@@Z  (thiscall, 2 slots, hand-written) */
static void imp_MSVCP60____0__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAE_PBDABV__allocator_D_1__Z(void) { IMPORT_STUB("??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDABV?$allocator@D@1@@Z"); RET(0); STDRET(2); }
/* MSVCP60.dll!??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____0__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAE_ABV01__Z(void) { IMPORT_STUB("??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z"); RET(0); STDRET(1); }
/* MSVCP60.dll!??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEABDI@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____A__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEABDI_Z(void) { IMPORT_STUB("??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEABDI@Z"); RET(0); STDRET(1); }
...
/* MSVCP60.dll!?_Refcnt@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEAAEPBD@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60____Refcnt___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEAAEPBD_Z(void) { IMPORT_STUB("?_Refcnt@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEAAEPBD@Z"); RET(0); STDRET(1); }
/* MSVCP60.dll!?_Freeze@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXXZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCP60____Freeze___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEXXZ(void) { IMPORT_STUB("?_Freeze@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXXZ"); RET(0); STDRET(0); }
/* MSVCP60.dll!?resize@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCP60___resize___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEXI_Z(void) { IMPORT_STUB("?resize@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z"); RET(0); STDRET(1); }
...
/* MSVCRT.dll!??1type_info@@UAE@XZ  (thiscall, 0 slots, hand-written) */
static void imp_MSVCRT____1type_info__UAE_XZ(void) { IMPORT_STUB("??1type_info@@UAE@XZ"); RET(0); STDRET(0); }
...
/* MSVCRT.dll!??8type_info@@QBEHABV0@@Z  (thiscall, 1 slots, hand-written) */
static void imp_MSVCRT____8type_info__QBEHABV0__Z(void) { IMPORT_STUB("??8type_info@@QBEHABV0@@Z"); RET(0); STDRET(1); }
...
const import_entry_t g_imports[] = {
    { 0x007C3000u, imp_ADVAPI32__RegCloseKey, "ADVAPI32.dll!RegCloseKey", "stdcall" },
    { 0x007C3004u, imp_ADVAPI32__RegCreateKeyExA, "ADVAPI32.dll!RegCreateKeyExA", "stdcall" },
    { 0x007C3008u, imp_ADVAPI32__RegQueryValueExA, "ADVAPI32.dll!RegQueryValueExA", "stdcall" },
    { 0x007C300Cu, imp_ADVAPI32__RegOpenKeyExA, "ADVAPI32.dll!RegOpenKeyExA", "stdcall" },
    { 0x007C3010u, imp_ADVAPI32__RegSetValueExA, "ADVAPI32.dll!RegSetValueExA", "stdcall" },
    { 0x007C3018u, imp_DINPUT__DirectInputCreateA, "DINPUT.dll!DirectInputCreateA", "stdcall" },
    { 0x007C3020u, imp_GDI32__GetStockObject, "GDI32.dll!GetStockObject", "stdcall" },
    { 0x007C3024u, imp_GDI32__StretchBlt, "GDI32.dll!StretchBlt", "stdcall" },
    { 0x007C3028u, imp_GDI32__DeleteDC, "GDI32.dll!DeleteDC", "stdcall" },
    { 0x007C302Cu, imp_GDI32__SetBkMode, "GDI32.dll!SetBkMode", "stdcall" },
    { 0x007C3030u, imp_GDI32__CreateCompatibleDC, "GDI32.dll!CreateCompatibleDC", "stdcall" },
    { 0x007C3034u, imp_GDI32__SelectObject, "GDI32.dll!SelectObject", "stdcall" },
    { 0x007C3038u, imp_GDI32__SetTextColor, "GDI32.dll!SetTextColor", "stdcall" },
    { 0x007C303Cu, imp_GDI32__CreateFontA, "GDI32.dll!CreateFontA", "stdcall" },
    { 0x007C3040u, imp_GDI32__DeleteObject, "GDI32.dll!DeleteObject", "stdcall" },
    { 0x007C3044u, imp_GDI32__TextOutA, "GDI32.dll!TextOutA", "stdcall" },
    { 0x007C3048u, imp_GDI32__GetTextExtentPoint32A, "GDI32.dll!GetTextExtentPoint32A", "stdcall" },
    { 0x007C3050u, imp_KERNEL32__Sleep, "KERNEL32.dll!Sleep", "stdcall" },
    { 0x007C3054u, imp_KERNEL32__FormatMessageA, "KERNEL32.dll!FormatMessageA", "stdcall" },
    { 0x007C3058u, imp_KERNEL32__CreateFileA, "KERNEL32.dll!CreateFileA", "stdcall" },
    { 0x007C305Cu, imp_KERNEL32__GetProcAddress, "KERNEL32.dll!GetProcAddress", "stdcall" },
    { 0x007C3060u, imp_KERNEL32__FreeLibrary, "KERNEL32.dll!FreeLibrary", "stdcall" },
    { 0x007C3064u, imp_KERNEL32__GetCurrentThreadId, "KERNEL32.dll!GetCurrentThreadId", "stdcall" },
    { 0x007C3068u, imp_KERNEL32__lstrlenA, "KERNEL32.dll!lstrlenA", "stdcall" },
    { 0x007C306Cu, imp_KERNEL32__GetVolumeInformationA, "KERNEL32.dll!GetVolumeInformationA", "stdcall" },
    { 0x007C3070u, imp_KERNEL32__GetLastError, "KERNEL32.dll!GetLastError", "stdcall" },
    { 0x007C3074u, imp_KERNEL32__GetModuleFileNameA, "KERNEL32.dll!GetModuleFileNameA", "stdcall" },
    { 0x007C3078u, imp_KERNEL32__LocalFree, "KERNEL32.dll!LocalFree", "stdcall" },
    { 0x007C307Cu, imp_KERNEL32__LoadLibraryA, "KERNEL32.dll!LoadLibraryA", "stdcall" },
    { 0x007C3080u, imp_KERNEL32__GetVersionExA, "KERNEL32.dll!GetVersionExA", "stdcall" },
    { 0x007C3084u, imp_KERNEL32__GetTickCount, "KERNEL32.dll!GetTickCount", "stdcall" },
    { 0x007C3088u, imp_KERNEL32__CloseHandle, "KERNEL32.dll!CloseHandle", "stdcall" },
    { 0x007C308Cu, imp_KERNEL32__CreateMutexA, "KERNEL32.dll!CreateMutexA", "stdcall" },
    { 0x007C3090u, imp_KERNEL32__QueryPerformanceFrequency, "KERNEL32.dll!QueryPerformanceFrequency", "stdcall" },
    { 0x007C3094u, imp_KERNEL32__QueryPerformanceCounter, "KERNEL32.dll!QueryPerformanceCounter", "stdcall" },
    { 0x007C3098u, imp_KERNEL32__CreateEventA, "KERNEL32.dll!CreateEventA", "stdcall" },
    { 0x007C309Cu, imp_KERNEL32__GetLocalTime, "KERNEL32.dll!GetLocalTime", "stdcall" },
    { 0x007C30A0u, imp_KERNEL32__Heap32ListNext, "KERNEL32.dll!Heap32ListNext", "stdcall" },
    { 0x007C30A4u, imp_KERNEL32__Heap32Next, "KERNEL32.dll!Heap32Next", "stdcall" },
    { 0x007C30A8u, imp_KERNEL32__Heap32First, "KERNEL32.dll!Heap32First", "stdcall" },
    { 0x007C30ACu, imp_KERNEL32__Heap32ListFirst, "KERNEL32.dll!Heap32ListFirst", "stdcall" },
    { 0x007C30B0u, imp_KERNEL32__Module32Next, "KERNEL32.dll!Module32Next", "stdcall" },
    { 0x007C30B4u, imp_KERNEL32__CreateToolhelp32Snapshot, "KERNEL32.dll!CreateToolhelp32Snapshot", "stdcall" },
    { 0x007C30B8u, imp_KERNEL32__GlobalMemoryStatus, "KERNEL32.dll!GlobalMemoryStatus", "stdcall" },
    { 0x007C30BCu, imp_KERNEL32__Module32First, "KERNEL32.dll!Module32First", "stdcall" },
    { 0x007C30C0u, imp_KERNEL32__WaitForSingleObject, "KERNEL32.dll!WaitForSingleObject", "stdcall" },
    { 0x007C30C4u, imp_KERNEL32__SetEvent, "KERNEL32.dll!SetEvent", "stdcall" },
    { 0x007C30C8u, imp_KERNEL32__GetSystemInfo, "KERNEL32.dll!GetSystemInfo", "stdcall" },
    { 0x007C30CCu, imp_KERNEL32__ResetEvent, "KERNEL32.dll!ResetEvent", "stdcall" },
    { 0x007C30D0u, imp_KERNEL32__ResumeThread, "KERNEL32.dll!ResumeThread", "stdcall" },
    { 0x007C30D4u, imp_KERNEL32__GetCurrentThread, "KERNEL32.dll!GetCurrentThread", "stdcall" },
    { 0x007C30D8u, imp_KERNEL32__LeaveCriticalSection, "KERNEL32.dll!LeaveCriticalSection", "stdcall" },
    { 0x007C30DCu, imp_KERNEL32__EnterCriticalSection, "KERNEL32.dll!EnterCriticalSection", "stdcall" },
    { 0x007C30E0u, imp_KERNEL32__CreateThread, "KERNEL32.dll!CreateThread", "stdcall" },
    { 0x007C30E4u, imp_KERNEL32__DeleteCriticalSection, "KERNEL32.dll!DeleteCriticalSection", "stdcall" },
    { 0x007C30E8u, imp_KERNEL32__ReleaseMutex, "KERNEL32.dll!ReleaseMutex", "stdcall" },
    { 0x007C30ECu, imp_KERNEL32__InitializeCriticalSection, "KERNEL32.dll!InitializeCriticalSection", "stdcall" },
    { 0x007C30F0u, imp_KERNEL32__SetFilePointer, "KERNEL32.dll!SetFilePointer", "stdcall" },
    { 0x007C30F4u, imp_KERNEL32__ReadFile, "KERNEL32.dll!ReadFile", "stdcall" },
    { 0x007C30F8u, imp_KERNEL32__PulseEvent, "KERNEL32.dll!PulseEvent", "stdcall" },
    { 0x007C30FCu, imp_KERNEL32__SetEndOfFile, "KERNEL32.dll!SetEndOfFile", "stdcall" },
    { 0x007C3100u, imp_KERNEL32__DeleteFileA, "KERNEL32.dll!DeleteFileA", "stdcall" },
    { 0x007C3104u, imp_KERNEL32__WriteFile, "KERNEL32.dll!WriteFile", "stdcall" },
    { 0x007C3108u, imp_KERNEL32__FindClose, "KERNEL32.dll!FindClose", "stdcall" },
    { 0x007C310Cu, imp_KERNEL32__FindNextFileA, "KERNEL32.dll!FindNextFileA", "stdcall" },
    { 0x007C3110u, imp_KERNEL32__FindFirstFileA, "KERNEL32.dll!FindFirstFileA", "stdcall" },
    { 0x007C3114u, imp_KERNEL32__CreateDirectoryA, "KERNEL32.dll!CreateDirectoryA", "stdcall" },
    { 0x007C3118u, imp_KERNEL32__RemoveDirectoryA, "KERNEL32.dll!RemoveDirectoryA", "stdcall" },
    { 0x007C311Cu, imp_KERNEL32__MoveFileA, "KERNEL32.dll!MoveFileA", "stdcall" },
    { 0x007C3120u, imp_KERNEL32__SetFileTime, "KERNEL32.dll!SetFileTime", "stdcall" },
    { 0x007C3124u, imp_KERNEL32__SetFileAttributesA, "KERNEL32.dll!SetFileAttributesA", "stdcall" },
    { 0x007C3128u, imp_KERNEL32__CopyFileA, "KERNEL32.dll!CopyFileA", "stdcall" },
    { 0x007C312Cu, imp_KERNEL32__OutputDebugStringA, "KERNEL32.dll!OutputDebugStringA", "stdcall" },
    { 0x007C3130u, imp_KERNEL32__FileTimeToSystemTime, "KERNEL32.dll!FileTimeToSystemTime", "stdcall" },
    { 0x007C3134u, imp_KERNEL32__FileTimeToLocalFileTime, "KERNEL32.dll!FileTimeToLocalFileTime", "stdcall" },
    { 0x007C3138u, imp_KERNEL32__LocalFileTimeToFileTime, "KERNEL32.dll!LocalFileTimeToFileTime", "stdcall" },
    { 0x007C313Cu, imp_KERNEL32__SystemTimeToFileTime, "KERNEL32.dll!SystemTimeToFileTime", "stdcall" },
    { 0x007C3140u, imp_KERNEL32__GetModuleHandleA, "KERNEL32.dll!GetModuleHandleA", "stdcall" },
    { 0x007C3144u, imp_KERNEL32__GetStartupInfoA, "KERNEL32.dll!GetStartupInfoA", "stdcall" },
    { 0x007C3148u, imp_KERNEL32__GetTempFileNameA, "KERNEL32.dll!GetTempFileNameA", "stdcall" },
    { 0x007C3150u, imp_MSVCP60____Y__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV01_ABV01__Z, "MSVCP60.dll!??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@ABV01@@Z", "thiscall" },
    { 0x007C3154u, imp_MSVCP60___copy___char_traits_D_std__SAPADPADPBDI_Z, "MSVCP60.dll!?copy@?$char_traits@D@std@@SAPADPADPBDI@Z", "cdecl" },
    { 0x007C3158u, imp_MSVCP60____Hstd__YA_AV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_ABV10_0_Z, "MSVCP60.dll!??Hstd@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@0@Z", "cdecl" },
    { 0x007C315Cu, imp_MSVCP60____1__basic_fstream_DU__char_traits_D_std___std__UAE_XZ, "MSVCP60.dll!??1?$basic_fstream@DU?$char_traits@D@std@@@std@@UAE@XZ", "thiscall" },
    { 0x007C3160u, imp_MSVCP60____Y__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV01_PBD_Z, "MSVCP60.dll!??Y?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z", "thiscall" },
    { 0x007C3164u, imp_MSVCP60____0__basic_ios_DU__char_traits_D_std___std__IAE_XZ, "MSVCP60.dll!??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ", "thiscall" },
    { 0x007C3168u, imp_MSVCP60___clear_ios_base_std__QAEXH_N_Z, "MSVCP60.dll!?clear@ios_base@std@@QAEXH_N@Z", "thiscall" },
    { 0x007C316Cu, imp_MSVCP60____6std__YAAAV__basic_ostream_DU__char_traits_D_std___0_AAV10_PBD_Z, "MSVCP60.dll!??6std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z", "cdecl" },
    { 0x007C3170u, imp_MSVCP60____Hstd__YA_AV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_PBDABV10__Z, "MSVCP60.dll!??Hstd@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBDABV10@@Z", "cdecl" },
    { 0x007C3174u, imp_MSVCP60___find_first_not_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z, "MSVCP60.dll!?find_first_not_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z", "thiscall" },
    { 0x007C3178u, imp_MSVCP60___max_size___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIXZ, "MSVCP60.dll!?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ", "thiscall" },
    { 0x007C317Cu, imp_MSVCP60___find___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z, "MSVCP60.dll!?find@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z", "thiscall" },
    { 0x007C3180u, imp_MSVCP60____Hstd__YA_AV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_ABV10_D_Z, "MSVCP60.dll!??Hstd@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@D@Z", "cdecl" },
    { 0x007C3184u, imp_MSVCP60_____F__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEXXZ, "MSVCP60.dll!??_F?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ", "thiscall" },
    { 0x007C3188u, imp_MSVCP60____9std__YA_NABV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_0_Z, "MSVCP60.dll!??9std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z", "cdecl" },
    { 0x007C318Cu, imp_MSVCP60____Ostd__YA_NABV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_0_Z, "MSVCP60.dll!??Ostd@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z", "cdecl" },
    { 0x007C3190u, imp_MSVCP60____8std__YA_NPBDABV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0__Z, "MSVCP60.dll!??8std@@YA_NPBDABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@@Z", "cdecl" },
    { 0x007C3194u, imp_MSVCP60___replace___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEAAV12_IIABV12_II_Z, "MSVCP60.dll!?replace@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IIABV12@II@Z", "thiscall" },
    { 0x007C3198u, imp_MSVCP60___find_last_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z, "MSVCP60.dll!?find_last_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z", "thiscall" },
    { 0x007C319Cu, imp_MSVCP60___find_last_not_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z, "MSVCP60.dll!?find_last_not_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z", "thiscall" },
    { 0x007C31A0u, imp_MSVCP60___copy___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPADII_Z, "MSVCP60.dll!?copy@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPADII@Z", "thiscall" },
    { 0x007C31A4u, imp_MSVCP60____Copy___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEXI_Z, "MSVCP60.dll!?_Copy@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXI@Z", "thiscall" },
    { 0x007C31A8u, imp_MSVCP60____Xran_std__YAXXZ, "MSVCP60.dll!?_Xran@std@@YAXXZ", "cdecl" },
    ...
    { 0x007C3210u, imp_MSVCP60_____D__basic_fstream_DU__char_traits_D_std___std__QAEXXZ, "MSVCP60.dll!??_D?$basic_fstream@DU?$char_traits@D@std@@@std@@QAEXXZ", "thiscall" },
    { 0x007C3214u, imp_MSVCP60____1ios_base_std__UAE_XZ, "MSVCP60.dll!??1ios_base@std@@UAE@XZ", "thiscall" },
    { 0x007C3218u, imp_MSVCP60____1__basic_ios_DU__char_traits_D_std___std__UAE_XZ, "MSVCP60.dll!??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ", "thiscall" },
    { 0x007C321Cu, imp_MSVCP60____1Init_ios_base_std__QAE_XZ, "MSVCP60.dll!??1Init@ios_base@std@@QAE@XZ", "thiscall" },
    { 0x007C3220u, imp_MSVCP60____1_Winit_std__QAE_XZ, "MSVCP60.dll!??1_Winit@std@@QAE@XZ", "thiscall" },
    { 0x007C3224u, imp_MSVCP60____0_Winit_std__QAE_XZ, "MSVCP60.dll!??0_Winit@std@@QAE@XZ", "thiscall" },
    { 0x007C3228u, imp_MSVCP60___find_first_of___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEIPBDII_Z, "MSVCP60.dll!?find_first_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIPBDII@Z", "thiscall" },
    { 0x007C322Cu, imp_MSVCP60____0Init_ios_base_std__QAE_XZ, "MSVCP60.dll!??0Init@ios_base@std@@QAE@XZ", "thiscall" },
    { 0x007C3230u, imp_MSVCP60___substr___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBE_AV12_II_Z, "MSVCP60.dll!?substr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV12@II@Z", "thiscall" },
    { 0x007C3234u, imp_MSVCP60____Hstd__YA_AV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_ABV10_PBD_Z, "MSVCP60.dll!??Hstd@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z", "cdecl" },
    { 0x007C3238u, imp_MSVCP60____0_Lockit_std__QAE_XZ, "MSVCP60.dll!??0_Lockit@std@@QAE@XZ", "thiscall" },
    ...
    { 0x007C3270u, imp_MSVCP60____9std__YA_NABV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_PBD_Z, "MSVCP60.dll!??9std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z", "cdecl" },
    { 0x007C3274u, imp_MSVCP60____8std__YA_NABV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_PBD_Z, "MSVCP60.dll!??8std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z", "cdecl" },
    { 0x007C3278u, imp_MSVCP60____0__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAE_PBDABV__allocator_D_1__Z, "MSVCP60.dll!??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDABV?$allocator@D@1@@Z", "thiscall" },
    { 0x007C327Cu, imp_MSVCP60____0__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAE_ABV01__Z, "MSVCP60.dll!??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ABV01@@Z", "thiscall" },
    { 0x007C3280u, imp_MSVCP60____A__basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QBEABDI_Z, "MSVCP60.dll!??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEABDI@Z", "thiscall" },
    { 0x007C3284u, imp_MSVCP60___nothrow_std__3Unothrow_t_1_B, "MSVCP60.dll!?nothrow@std@@3Unothrow_t@1@B", "data" },
    { 0x007C3288u, imp_MSVCP60____8std__YA_NABV__basic_string_DU__char_traits_D_std__V__allocator_D_2__0_0_Z, "MSVCP60.dll!??8std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z", "cdecl" },
    { 0x007C328Cu, imp_MSVCP60____Refcnt___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEAAEPBD_Z, "MSVCP60.dll!?_Refcnt@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEAAEPBD@Z", "thiscall" },
    { 0x007C3290u, imp_MSVCP60____Freeze___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__AAEXXZ, "MSVCP60.dll!?_Freeze@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AAEXXZ", "thiscall" },
    { 0x007C3294u, imp_MSVCP60___resize___basic_string_DU__char_traits_D_std__V__allocator_D_2__std__QAEXI_Z, "MSVCP60.dll!?resize@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z", "thiscall" },
    { 0x007C329Cu, imp_MSVCRT___terminate__YAXXZ, "MSVCRT.dll!?terminate@@YAXXZ", "cdecl" },
    { 0x007C32A0u, imp_MSVCRT___onexit, "MSVCRT.dll!_onexit", "cdecl" },
    { 0x007C32A4u, imp_MSVCRT____dllonexit, "MSVCRT.dll!__dllonexit", "cdecl" },
    { 0x007C32A8u, imp_MSVCRT___except_handler3, "MSVCRT.dll!_except_handler3", "cdecl" },
    { 0x007C32ACu, imp_MSVCRT____set_app_type, "MSVCRT.dll!__set_app_type", "cdecl" },
    { 0x007C32B0u, imp_MSVCRT____p__fmode, "MSVCRT.dll!__p__fmode", "cdecl" },
    { 0x007C32B4u, imp_MSVCRT____p__commode, "MSVCRT.dll!__p__commode", "cdecl" },
    { 0x007C32B8u, imp_MSVCRT___adjust_fdiv, "MSVCRT.dll!_adjust_fdiv", "cdecl" },
    { 0x007C32BCu, imp_MSVCRT____setusermatherr, "MSVCRT.dll!__setusermatherr", "cdecl" },
    { 0x007C32C0u, imp_MSVCRT___initterm, "MSVCRT.dll!_initterm", "cdecl" },
    { 0x007C32C4u, imp_MSVCRT____getmainargs, "MSVCRT.dll!__getmainargs", "cdecl" },
    { 0x007C32C8u, imp_MSVCRT__exit, "MSVCRT.dll!exit", "cdecl" },
    { 0x007C32CCu, imp_MSVCRT___XcptFilter, "MSVCRT.dll!_XcptFilter", "cdecl" },
    { 0x007C32D0u, imp_MSVCRT___exit, "MSVCRT.dll!_exit", "cdecl" },
    { 0x007C32D4u, imp_MSVCRT____1type_info__UAE_XZ, "MSVCRT.dll!??1type_info@@UAE@XZ", "thiscall" },
    { 0x007C32D8u, imp_MSVCRT__fgets, "MSVCRT.dll!fgets", "cdecl" },
    { 0x007C32DCu, imp_MSVCRT__fseek, "MSVCRT.dll!fseek", "cdecl" },
    { 0x007C32E0u, imp_MSVCRT__ftell, "MSVCRT.dll!ftell", "cdecl" },
    { 0x007C32E4u, imp_MSVCRT__isalpha, "MSVCRT.dll!isalpha", "cdecl" },
    { 0x007C32E8u, imp_MSVCRT__strncmp, "MSVCRT.dll!strncmp", "cdecl" },
    { 0x007C32ECu, imp_MSVCRT__mktime, "MSVCRT.dll!mktime", "cdecl" },
    { 0x007C32F0u, imp_MSVCRT___controlfp, "MSVCRT.dll!_controlfp", "cdecl" },
    { 0x007C32F4u, imp_MSVCRT___splitpath, "MSVCRT.dll!_splitpath", "cdecl" },
    { 0x007C32F8u, imp_MSVCRT___fullpath, "MSVCRT.dll!_fullpath", "cdecl" },
    { 0x007C32FCu, imp_MSVCRT__memchr, "MSVCRT.dll!memchr", "cdecl" },
    { 0x007C3300u, imp_MSVCRT__atoi, "MSVCRT.dll!atoi", "cdecl" },
    { 0x007C3304u, imp_MSVCRT__strncpy, "MSVCRT.dll!strncpy", "cdecl" },
    { 0x007C3308u, imp_MSVCRT___stricmp, "MSVCRT.dll!_stricmp", "cdecl" },
    { 0x007C330Cu, imp_MSVCRT__vsprintf, "MSVCRT.dll!vsprintf", "cdecl" },
    { 0x007C3310u, imp_MSVCRT__fprintf, "MSVCRT.dll!fprintf", "cdecl" },
    { 0x007C3314u, imp_MSVCRT__fopen, "MSVCRT.dll!fopen", "cdecl" },
    { 0x007C3318u, imp_MSVCRT__fread, "MSVCRT.dll!fread", "cdecl" },
    { 0x007C331Cu, imp_MSVCRT__fclose, "MSVCRT.dll!fclose", "cdecl" },
    { 0x007C3320u, imp_MSVCRT__ceil, "MSVCRT.dll!ceil", "cdecl" },
    { 0x007C3324u, imp_MSVCRT___purecall, "MSVCRT.dll!_purecall", "cdecl" },
    { 0x007C3328u, imp_MSVCRT__sscanf, "MSVCRT.dll!sscanf", "cdecl" },
    { 0x007C332Cu, imp_MSVCRT___CIacos, "MSVCRT.dll!_CIacos", "cdecl" },
    { 0x007C3330u, imp_MSVCRT___CIasin, "MSVCRT.dll!_CIasin", "cdecl" },
    { 0x007C3334u, imp_MSVCRT____RTDynamicCast, "MSVCRT.dll!__RTDynamicCast", "cdecl" },
    { 0x007C3338u, imp_MSVCRT__memmove, "MSVCRT.dll!memmove", "cdecl" },
    { 0x007C333Cu, imp_MSVCRT__sprintf, "MSVCRT.dll!sprintf", "cdecl" },
    { 0x007C3340u, imp_MSVCRT___ftol, "MSVCRT.dll!_ftol", "cdecl" },
    { 0x007C3344u, imp_MSVCRT____2_YAPAXI_Z, "MSVCRT.dll!??2@YAPAXI@Z", "cdecl" },
    { 0x007C3348u, imp_MSVCRT____CxxFrameHandler, "MSVCRT.dll!__CxxFrameHandler", "cdecl" },
    { 0x007C334Cu, imp_MSVCRT__free, "MSVCRT.dll!free", "cdecl" },
    { 0x007C3350u, imp_MSVCRT__malloc, "MSVCRT.dll!malloc", "cdecl" },
    { 0x007C3354u, imp_MSVCRT___CxxThrowException, "MSVCRT.dll!_CxxThrowException", "cdecl" },
    { 0x007C3358u, imp_MSVCRT___acmdln, "MSVCRT.dll!_acmdln", "cdecl" },
    { 0x007C335Cu, imp_MSVCRT__atof, "MSVCRT.dll!atof", "cdecl" },
    { 0x007C3360u, imp_MSVCRT__bsearch, "MSVCRT.dll!bsearch", "cdecl" },
    { 0x007C3364u, imp_MSVCRT___strnicmp, "MSVCRT.dll!_strnicmp", "cdecl" },
    { 0x007C3368u, imp_MSVCRT___CIfmod, "MSVCRT.dll!_CIfmod", "cdecl" },
    { 0x007C336Cu, imp_MSVCRT____8type_info__QBEHABV0__Z, "MSVCRT.dll!??8type_info@@QBEHABV0@@Z", "thiscall" },
    { 0x007C3370u, imp_MSVCRT__floor, "MSVCRT.dll!floor", "cdecl" },
    { 0x007C3374u, imp_MSVCRT__toupper, "MSVCRT.dll!toupper", "cdecl" },
    { 0x007C3378u, imp_MSVCRT___CIpow, "MSVCRT.dll!_CIpow", "cdecl" },
    { 0x007C337Cu, imp_MSVCRT____RTtypeid, "MSVCRT.dll!__RTtypeid", "cdecl" },
    { 0x007C3380u, imp_MSVCRT__isdigit, "MSVCRT.dll!isdigit", "cdecl" },
    { 0x007C3384u, imp_MSVCRT__isxdigit, "MSVCRT.dll!isxdigit", "cdecl" },
    { 0x007C3388u, imp_MSVCRT__tolower, "MSVCRT.dll!tolower", "cdecl" },
    { 0x007C338Cu, imp_MSVCRT__isupper, "MSVCRT.dll!isupper", "cdecl" },
    { 0x007C3390u, imp_MSVCRT__islower, "MSVCRT.dll!islower", "cdecl" },
    { 0x007C3394u, imp_MSVCRT__isalnum, "MSVCRT.dll!isalnum", "cdecl" },
    { 0x007C3398u, imp_MSVCRT__isspace, "MSVCRT.dll!isspace", "cdecl" },
    { 0x007C339Cu, imp_MSVCRT___callnewh, "MSVCRT.dll!_callnewh", "cdecl" },
    { 0x007C33A0u, imp_MSVCRT__isprint, "MSVCRT.dll!isprint", "cdecl" },
    { 0x007C33A4u, imp_MSVCRT__realloc, "MSVCRT.dll!realloc", "cdecl" },
    { 0x007C33ACu, imp_SHELL32__ShellExecuteA, "SHELL32.dll!ShellExecuteA", "stdcall" },
    { 0x007C33B4u, imp_USER32__CreateWindowExA, "USER32.dll!CreateWindowExA", "stdcall" },
    { 0x007C33B8u, imp_USER32__CharPrevA, "USER32.dll!CharPrevA", "stdcall" },
    { 0x007C33BCu, imp_USER32__PostThreadMessageA, "USER32.dll!PostThreadMessageA", "stdcall" },
    { 0x007C33C0u, imp_USER32__SetWindowTextA, "USER32.dll!SetWindowTextA", "stdcall" },
    { 0x007C33C4u, imp_USER32__SetWindowPos, "USER32.dll!SetWindowPos", "stdcall" },
    { 0x007C33C8u, imp_USER32__GetSystemMetrics, "USER32.dll!GetSystemMetrics", "stdcall" },
    { 0x007C33CCu, imp_USER32__EndPaint, "USER32.dll!EndPaint", "stdcall" },
    { 0x007C33D0u, imp_USER32__CreateDialogParamA, "USER32.dll!CreateDialogParamA", "stdcall" },
    { 0x007C33D4u, imp_USER32__SetCursor, "USER32.dll!SetCursor", "stdcall" },
    { 0x007C33D8u, imp_USER32__PeekMessageA, "USER32.dll!PeekMessageA", "stdcall" },
    { 0x007C33DCu, imp_USER32__GetWindowTextA, "USER32.dll!GetWindowTextA", "stdcall" },
    { 0x007C33E0u, imp_USER32__MsgWaitForMultipleObjects, "USER32.dll!MsgWaitForMultipleObjects", "stdcall" },
    { 0x007C33E4u, imp_USER32__DispatchMessageA, "USER32.dll!DispatchMessageA", "stdcall" },
    { 0x007C33E8u, imp_USER32__GetMessageA, "USER32.dll!GetMessageA", "stdcall" },
    { 0x007C33ECu, imp_USER32__TranslateMessage, "USER32.dll!TranslateMessage", "stdcall" },
    { 0x007C33F0u, imp_USER32__RegisterClassExA, "USER32.dll!RegisterClassExA", "stdcall" },
    { 0x007C33F4u, imp_USER32__CharNextA, "USER32.dll!CharNextA", "stdcall" },
    { 0x007C33F8u, imp_USER32__ShowWindow, "USER32.dll!ShowWindow", "stdcall" },
    { 0x007C33FCu, imp_USER32__GetWindowRect, "USER32.dll!GetWindowRect", "stdcall" },
    { 0x007C3400u, imp_USER32__BeginPaint, "USER32.dll!BeginPaint", "stdcall" },
    { 0x007C3404u, imp_USER32__GetUpdateRect, "USER32.dll!GetUpdateRect", "stdcall" },
    { 0x007C3408u, imp_USER32__LoadBitmapA, "USER32.dll!LoadBitmapA", "stdcall" },
    { 0x007C340Cu, imp_USER32__LoadCursorA, "USER32.dll!LoadCursorA", "stdcall" },
    { 0x007C3410u, imp_USER32__MessageBoxA, "USER32.dll!MessageBoxA", "stdcall" },
    { 0x007C3414u, imp_USER32__UpdateWindow, "USER32.dll!UpdateWindow", "stdcall" },
    { 0x007C3418u, imp_USER32__IsWindowVisible, "USER32.dll!IsWindowVisible", "stdcall" },
    { 0x007C341Cu, imp_USER32__SetParent, "USER32.dll!SetParent", "stdcall" },
    { 0x007C3420u, imp_USER32__DestroyWindow, "USER32.dll!DestroyWindow", "stdcall" },
    { 0x007C3424u, imp_USER32__IsWindow, "USER32.dll!IsWindow", "stdcall" },
    { 0x007C3428u, imp_USER32__IsIconic, "USER32.dll!IsIconic", "stdcall" },
    { 0x007C342Cu, imp_USER32__GetDesktopWindow, "USER32.dll!GetDesktopWindow", "stdcall" },
    { 0x007C3430u, imp_USER32__ClientToScreen, "USER32.dll!ClientToScreen", "stdcall" },
    { 0x007C3434u, imp_USER32__SetCursorPos, "USER32.dll!SetCursorPos", "stdcall" },
    { 0x007C3438u, imp_USER32__GetKeyState, "USER32.dll!GetKeyState", "stdcall" },
    { 0x007C343Cu, imp_USER32__ShowCursor, "USER32.dll!ShowCursor", "stdcall" },
    { 0x007C3440u, imp_USER32__GetParent, "USER32.dll!GetParent", "stdcall" },
    { 0x007C3444u, imp_USER32__SetWindowPlacement, "USER32.dll!SetWindowPlacement", "stdcall" },
    { 0x007C3448u, imp_USER32__GetWindowLongA, "USER32.dll!GetWindowLongA", "stdcall" },
    { 0x007C344Cu, imp_USER32__GetWindowPlacement, "USER32.dll!GetWindowPlacement", "stdcall" },
    { 0x007C3450u, imp_USER32__SetWindowLongA, "USER32.dll!SetWindowLongA", "stdcall" },
    { 0x007C3454u, imp_USER32__GetClientRect, "USER32.dll!GetClientRect", "stdcall" },
    { 0x007C3458u, imp_USER32__DefWindowProcA, "USER32.dll!DefWindowProcA", "stdcall" },
    { 0x007C345Cu, imp_USER32__SetPropA, "USER32.dll!SetPropA", "stdcall" },
    { 0x007C3460u, imp_USER32__GetPropA, "USER32.dll!GetPropA", "stdcall" },
    { 0x007C3468u, imp_WINMM__timeSetEvent, "WINMM.dll!timeSetEvent", "stdcall" },
    { 0x007C346Cu, imp_WINMM__timeEndPeriod, "WINMM.dll!timeEndPeriod", "stdcall" },
    { 0x007C3470u, imp_WINMM__timeGetTime, "WINMM.dll!timeGetTime", "stdcall" },
    { 0x007C3474u, imp_WINMM__mciSendStringA, "WINMM.dll!mciSendStringA", "stdcall" },
    { 0x007C3478u, imp_WINMM__PlaySoundA, "WINMM.dll!PlaySoundA", "stdcall" },
    { 0x007C347Cu, imp_WINMM__timeKillEvent, "WINMM.dll!timeKillEvent", "stdcall" },
    { 0x007C3480u, imp_WINMM__timeBeginPeriod, "WINMM.dll!timeBeginPeriod", "stdcall" },
    { 0x007C3484u, imp_WINMM__timeGetDevCaps, "WINMM.dll!timeGetDevCaps", "stdcall" },
    { 0x007C348Cu, imp_mss32___AIL_startup_0, "mss32.dll!_AIL_startup@0", "stdcall" },
    { 0x007C3490u, imp_mss32___AIL_digital_handle_release_4, "mss32.dll!_AIL_digital_handle_release@4", "stdcall" },
    { 0x007C3494u, imp_mss32___AIL_digital_handle_reacquire_4, "mss32.dll!_AIL_digital_handle_reacquire@4", "stdcall" },
    { 0x007C3498u, imp_mss32___AIL_allocate_sample_handle_4, "mss32.dll!_AIL_allocate_sample_handle@4", "stdcall" },
    { 0x007C349Cu, imp_mss32___AIL_set_DirectSound_HWND_8, "mss32.dll!_AIL_set_DirectSound_HWND@8", "stdcall" },
    { 0x007C34A0u, imp_mss32___AIL_last_error_0, "mss32.dll!_AIL_last_error@0", "stdcall" },
    { 0x007C34A4u, imp_mss32___AIL_waveOutOpen_16, "mss32.dll!_AIL_waveOutOpen@16", "stdcall" },
    { 0x007C34A8u, imp_mss32___AIL_set_preference_8, "mss32.dll!_AIL_set_preference@8", "stdcall" },
    { 0x007C34ACu, imp_mss32___AIL_set_sample_pan_8, "mss32.dll!_AIL_set_sample_pan@8", "stdcall" },
    { 0x007C34B0u, imp_mss32___AIL_shutdown_0, "mss32.dll!_AIL_shutdown@0", "stdcall" },
    { 0x007C34B4u, imp_mss32___AIL_waveOutClose_4, "mss32.dll!_AIL_waveOutClose@4", "stdcall" },
    { 0x007C34B8u, imp_mss32___AIL_release_sample_handle_4, "mss32.dll!_AIL_release_sample_handle@4", "stdcall" },
    { 0x007C34BCu, imp_mss32___AIL_get_DirectSound_info_12, "mss32.dll!_AIL_get_DirectSound_info@12", "stdcall" },
    { 0x007C34C0u, imp_mss32___AIL_set_sample_playback_rate_8, "mss32.dll!_AIL_set_sample_playback_rate@8", "stdcall" },
    { 0x007C34C4u, imp_mss32___AIL_set_named_sample_file_20, "mss32.dll!_AIL_set_named_sample_file@20", "stdcall" },
    { 0x007C34C8u, imp_mss32___AIL_start_sample_4, "mss32.dll!_AIL_start_sample@4", "stdcall" },
    { 0x007C34CCu, imp_mss32___AIL_set_sample_loop_count_8, "mss32.dll!_AIL_set_sample_loop_count@8", "stdcall" },
    { 0x007C34D0u, imp_mss32___AIL_set_sample_file_12, "mss32.dll!_AIL_set_sample_file@12", "stdcall" },
    { 0x007C34D4u, imp_mss32___AIL_set_sample_volume_8, "mss32.dll!_AIL_set_sample_volume@8", "stdcall" },
    { 0x007C34D8u, imp_mss32___AIL_end_sample_4, "mss32.dll!_AIL_end_sample@4", "stdcall" },
    { 0x007C34DCu, imp_mss32___AIL_init_sample_4, "mss32.dll!_AIL_init_sample@4", "stdcall" },
    { 0x007C34E0u, imp_mss32___AIL_sample_status_4, "mss32.dll!_AIL_sample_status@4", "stdcall" },
    { 0x007C34E8u, imp_ole32__CoInitialize, "ole32.dll!CoInitialize", "stdcall" },
    { 0x007C34ECu, imp_ole32__CoUninitialize, "ole32.dll!CoUninitialize", "stdcall" },
    { 0x007C34F0u, imp_ole32__CoCreateInstance, "ole32.dll!CoCreateInstance", "stdcall" },
};
